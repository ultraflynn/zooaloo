...
module.exports = () => {
  ...
  let currentPlayer = "player1",
      ...
      board = [
        {action: "takeTrain"},
        {action: "enterMonkeyHouse"},
        {action: "takeCard"},
        {action: "enterBirdHouse"},
        {action: "enterBigCatHouse"},
        {action: "takeTrain"},
        {action: "takeCard"},
        {action: "enterAfricanAnimalHouse"},
        {action: "takeTrain"},
        {action: "enterInsectHouse"},
        {action: "takeCard"},
        {action: "enterReptileHouse"},
        {action: "enterFoodStorage"},
        {action: "takeCard"},
        {action: "enterCleaningStorage"},
        {action: "enterStart"},
      ]
  ...
  moveUp() {
    ...
    movesLeft--
    return board[positions[currentPlayer]]
  },
  moveDown() {
    positions[currentPlayer]--
    movesLeft--
  ...
  isPlayerAtTop() {
    return positions[currentPlayer] === 15
  },
  isPlayerAtBottom() {
    return positions[currentPlayer] === 0
  },
  setMovesLeft(n) {
    movesLeft = n
  }
